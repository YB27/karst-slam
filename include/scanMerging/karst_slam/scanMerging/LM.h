/* +---------------------------------------------------------------------------+
   ...
   +---------------------------------------------------------------------------+ */
#ifndef  LM_MRPT_MODIFY_H
#define  LM_MRPT_MODIFY_H
...
/**
 * Copy/Paste of MRPT LM classes with just the increment of x (values to estimate) moved after the check of improvement.
 * It allows for Lie algebra opt by always being in the tangent plane of the current estimation
 * \todo Already done this for MSIS scan matching !!!! -> Make my own LM class adapted for both uses.
 */
namespace mrpt
{
namespace math
{
        ...
        class LM_modifyTempl : public mrpt::utils::COutputLogger
        {
        public:
                ...
                LM_modifyTempl() :
                        mrpt::utils::COutputLogger("LM_modifyTempl")
                {}
                        ...
                        )
                {
                        ...
                        // Modification : need to change userParam
                        USERPARAM& userParam_ = const_cast<USERPARAM&>(userParam);
                        ...
                        while (!found && ++iter<maxIter)
                        {
                                ...
                                else
                                {
                                    ...
                                    //////////////////////////////////////
                                        ...
                                        {
                                            userParam_.isImprovement = false;
                                            x_increment_adder(xnew, x, h_lm, userParam_);
                                        }
        ...
        typedef LM_modifyTempl<mrpt::math::CVectorDouble> LM_modify;  //!< The default name for the LM class is an instantiation for "double"
